...
public class ProviderUserFallback implements ZuulFallbackProvider {
    private static final Logger LOGGER = LoggerFactory.getLogger(ProviderUserFallback.class);
    @Override
    public String getRoute() {
        return "attendance-provider-user";
    }
    ...
    public ClientHttpResponse fallbackResponse() {
        return new ClientHttpResponse() {
            ...
            public InputStream getBody() throws IOException {
                LOGGER.error("zuul fallback " + ProviderUserFallback.this.getRoute().toString());
                ResultObj resultObj = ResultObj.errorWithLog(HttpStatus.INTERNAL_SERVER_ERROR.value(),
                        "服务请求失败",ProviderUserFallback.this.getRoute().toString());
